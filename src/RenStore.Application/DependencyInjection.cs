...
using RenStore.Application.Common.Mappings.Delivery;
...
using RenStore.Application.Features.Delivery.Commands.Update;
...
public static class DependencyInjection
{
        ...
        this IServiceCollection services)
    {
        ...
        // Delivery
        services.AddAutoMapper(typeof(CreateDeliveryMappingProfile));
        ...
        services.AddMediatR(x =>
            x.RegisterServicesFromAssemblies(
                typeof(CreateDeliveryCommand).Assembly,
                typeof(CreateDeliveryCommandHandler).Assembly,
                typeof(UpdateDeliveryCommandHandler).Assembly,
                typeof(UpdateCategoryCommand).Assembly,
                typeof(DeleteDeliveryCommandHandler).Assembly,
                typeof(DeleteDeliveryCommand).Assembly,
                typeof(GetAllDeliveriesQueryHandler).Assembly,
                typeof(GetAllDeliveriesQuery).Assembly,
                typeof(GetAllDeliveriesByProductIdQueryHandler).Assembly,
                typeof(GetAllDeliveriesByProductIdQuery).Assembly,
                typeof(GetAllDeliveriesBySellerIdQueryHandler).Assembly,
                typeof(GetAllDeliveriesBySellerIdQuery).Assembly
                ));
